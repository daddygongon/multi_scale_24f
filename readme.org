...
| 08(11/13) | listplot3d, dirs | maple                       |
| 09(11/20) | rake,  bundler   | scaffolding, DSL            |
...
- hyper_card
  - meta
    - semi_lattice, grain size, chunking, # small, same, tb
  - beta
    - tldr, tree, bat, fd
- unix
...
- emacs
  - browser_url
- git
  - merge, private_invite
- ruby
  - basic_six, auto_git, shebang, 
